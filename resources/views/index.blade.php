...
<body class="font-sans antialiased">
    <div class="bg-gray-50 text-black/50">
        <img id="background" class="absolute" src="{{ asset('assets/img/background.jpg') }}" />
        <div
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                <main class="mt-6">
                    <div class="grid gap-6 lg:grid-cols-1 lg:gap-8">
                        <div id="table-card"
                            class="flex flex-col items-start gap-12 overflow-hidden rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] md:row-span-3 lg:p-10 lg:pb-10">
                            <div id="table-container" class="relative flex w-full flex-1 items-stretch">
                                <div class="table100 ver5 w-full">

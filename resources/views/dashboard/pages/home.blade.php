...
<!-- Page Scripts -->
@section('page-script')
    @vite(['resources/assets/js/tables-datatables-activities.js'])
@endsection
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <div class="form-floating form-floating-outline">
                            <input type="text" class="form-control dt-date" id="date" name="date"
                                aria-describedby="date" placeholder="DD/MM/YYYY" aria-label="DD/MM/YYYY" />
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <div class="form-floating form-floating-outline">
                            <input type="text" id="day" class="form-control dt-day" name="day"
                                placeholder="Senin" aria-label="Senin" aria-describedby="day2" />
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <div class="form-floating form-floating-outline">
                            <input type="time" id="time" class="form-control dt-time" name="time"
                                aria-describedby="time2" value="14:00" />
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <div class="form-floating form-floating-outline">
                            <input type="text" id="activity" class="form-control dt-activity" name="activity"
                                placeholder="Seminar" aria-label="Seminar" aria-describedby="activity2" />
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <div class="form-floating form-floating-outline">
                            <input type="text" id="location" class="form-control dt-location" name="location"
                                placeholder="Gedung Seminar" aria-label="Gedung Seminar" aria-describedby="location2" />
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <div class="form-floating form-floating-outline">
                            <input type="text" id="pic" class="form-control dt-pic" name="pic"
                                placeholder="Budi" aria-label="Budi" aria-describedby="pic2" />
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <div class="form-floating form-floating-outline">
                            <input type="text" id="phone_number" class="form-control dt-phone-number"
                                name="phone_number" placeholder="08172777777" aria-label="08172777777"
